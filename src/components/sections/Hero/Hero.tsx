...
export function Hero() {
  ...
  return (
    <section id="top" data-section="hero" className="p-inset-sm nav:p-inset">
      <div className="rounded-shell nav:h-[calc(100svh-4.5rem)] relative flex h-[calc(100svh-2rem)] flex-col overflow-hidden">
        <motion.div
          aria-hidden
        ...
        <div
          aria-hidden
          className="absolute inset-0 bg-[radial-gradient(120%_95%_at_50%_8%,transparent_35%,rgba(0,0,0,0.55)_100%)]"
        />
        <GrainOverlay />
