...
export const es = {
  ...
  hero: {
    line1: 'Imagina un espacio',
    line2: 'entre idea y producto',
    sub: 'Ahí es donde construyo.',
  ...
  testimonials: {
    ...
    goTo: 'Ir a la reseña',
    paginationLabel: 'Paginación de reseñas',
    regionLabel: 'Reseñas',
  },
  stats: {
  ...
  founders: {
    ...
    sub: 'Siempre se me antoja un café y una buena plática',
